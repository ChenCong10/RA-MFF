...
class FusionModel(nn.Module):
    def __init__(self, in_c=3, out_c=3, n_feat=96, scale_unetfeats=48,
        ...
        self.channel_adapter = nn.Conv2d(n_feat * 3, n_feat, kernel_size=1)
        # self.seaab = Block(dim=n_feat * 3, key_dim=72, num_heads=9)  # outputs n_feat*3 channels

        # =============================================================
        # == New 1×1 conv layers for channel alignment ================
        # =============================================================
        # 288→36, for first LCA
        self.reduce36 = nn.Conv2d(n_feat * 3, 36, kernel_size=1, bias=False)
    ...
    def forward(self, img1, img2):
        ...
        # ===========================================
        # Level 1 (36)
        feat1_36 = self.reduce36(concat_1)
        feat2_36  = self.reduce36(concat_2)
